...
package com.threaddynamics.jasperclient.resteasy.provider;
...
import com.threaddynamics.jasperclient.dto.JasperReport;
...
@Produces("*/*")
@Consumes("*/*")
public class JasperReportProvider implements MessageBodyReader<JasperReport> {

    /** The Constant PREFIX. */
    private static final String PREFIX = "jasper";
    ...
    /** The Constant logger. */
    private final static Logger logger = Logger.getLogger(JasperReportProvider.class);
    ...
    public boolean isReadable(final Class<?> type, final Type genericType,
        ...
        return JasperReport.class == type;
    }
     ...
     */
    @Override
    public JasperReport readFrom(final Class<JasperReport> type, final Type genericType,
        final Annotation[] annotations, final MediaType mediaType,
        ...
        final JasperReport documentContent = new JasperReport();
        String prefix = null;
        String suffix = null;
        ...
        documentContent.setReportFile(downloadedFile);
    ...
    private void setDocumentAttributes(final ContentDisposition contentDisposition,
        final JasperReport DocumentContent) {
